                ...
                <Card className="trending_card">
                    <Card.Header>
                        <div className='d-flex align-items-center'>
                            <div className='trending_badge d-flex align-items-center me-3'>
                                <FontAwesomeIcon className='color-second text-white font-14 me-2' icon={faHeart} />
                                <span className="font-14 text-white">1.8K</span>
                            </div>
                            <p className='font-14 color-second m-0 p-0'>
                    ...
                    <Card.Body>
                        <Row className='align-items-center'>
                            <Col sm={4}>
                                <Card.Body.Image>
                                    <Image src={cardImg} className="trending_card_img" alt="card_img" />
                                </Card.Body.Image>
                            </Col>
                            <Col sm={8}>
                                <div className='trending_card_text_box'>
                                    ...
                                    <p className="font-16 text-black m-0 p-0 trending_card_text_description">
