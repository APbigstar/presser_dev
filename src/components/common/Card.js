...
Card.Body.Text = (props) => <div className={`body-text ${props.className ? props.className : ''}`}> {props.children} </div>
Card.Body.Image = (props) => <div className={`body-img ${props.className ? props.className : ''}`}> {props.children} </div>
